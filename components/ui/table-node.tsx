  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <ToolbarGroup>
            <ColorDropdownMenu tooltip="Couleur de fond">
              <PaintBucketIcon />
            </ColorDropdownMenu>
            {canMerge && (
              <ToolbarButton
            ...
            {collapsedInside && (
              <ToolbarGroup>
                <ToolbarButton tooltip="Supprimer le tableau" {...buttonProps}>
                  <Trash2Icon />
                </ToolbarButton>
              </ToolbarGroup>
            )}
          ...
          {collapsedInside && (
            <ToolbarGroup>
              <ToolbarButton
                ...
                onMouseDown={(e) => e.preventDefault()}
                tooltip="Insérer une ligne avant"
              >
                <ArrowUp />
              </ToolbarButton>
              <ToolbarButton
                ...
                onMouseDown={(e) => e.preventDefault()}
                tooltip="Insérer une ligne après"
              >
                <ArrowDown />
              </ToolbarButton>
              <ToolbarButton
